...
import org.firstinspires.ftc.teamcode.log.DatalogEntropicShooter;
import java.text.SimpleDateFormat;
@Disabled
@TeleOp(name = "Logging: Bionic", group = "Logging")
public class EntropicShooterLogging extends LinearOpMode {
    double powerIncrement = 0.05;

    DatalogEntropicShooter log;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        log = new DatalogEntropicShooter("entropicShooterTester_" + timeStamp);

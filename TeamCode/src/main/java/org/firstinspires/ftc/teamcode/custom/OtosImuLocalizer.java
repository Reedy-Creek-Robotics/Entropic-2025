 ...
 */
public class OtosImuLocalizer implements Localizer {
    ...
    private final AngleUnit imuUnit;
    private double imuDifference;
     ...
     */
    public OtosImuLocalizer(HardwareMap map, OtosImuConstants constants) {
    ...
    public OtosImuLocalizer(HardwareMap map, OtosImuConstants constants, Pose setStartPose) {

        log = new LogCatUtil("Localizer");
        hardwareUtil = new HardwareUtil(log, map);

        otos = hardwareUtil.getOtos(constants.otosHardwareMapName);
        imu = hardwareUtil.getImu(constants.imuHardwareMapName);
        ...
        imu.initialize(constants.imuParameters);
        imuUnit = constants.angleUnit;
        angularScalar = constants.angularScalar;
    ...
    /**
     * This resets the yaw on the IMU.
     */
    ...
    /**
     * This returns true if any component of robot's position is NaN.
     *
     * @return whether the robot's position is NaN
     */
